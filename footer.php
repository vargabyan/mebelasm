    ...
    <div class="footer container-core">
        <div class="footer_menu-wrapper">
            <ul class="footer_menu_contacts">
                ...
                <li class="footer_menu_contacts_item"><p><a href="tel:+7 800 256 83 02">+7 800 256 83 02</a>Горячая линия</p></li>
        ...
        <hr class="footer_menu_demarcation-line">
        <div class="footer_other_wrapper">
            <div class="footer_other">
                <ul class="footer_other_item-wrapper">
                    <li class="footer_other_item"><a href="">Политика конфиденциальности</a></li>
                    <li class="footer_other_item"><a href="">Карта сайта</a></li>
                    <li class="footer_other_item"><a href="">Политика оферты</a></li>
                </ul>
                <ul class="footer_follow">
                    <li class="footer_follow_item"><a href=""></a></li>
                    <li class="footer_follow_item"><a href=""></a></li>
                    <li class="footer_follow_item"><a href=""></a></li>
                    <li class="footer_follow_item"><a href=""></a></li>
                </ul>
            </div>
            <div class="footer_other_about-organisation">
                <p class="footer_other_about-organisation_item">ООО «Домашний Интерьер», ОГРН: 1077763747269123290, г. Москва, 1-й Магистральный проезд, д.11, стр.1, пом. II, этаж 2, ком. 54</p>
                <p class="footer_other_about-organisation_item">© ГК АСМ, 1993—2023</p>
            </div>
        </div>
    </div>
</footer>
